...
export default function App() {
  ...
  const handleManualConnect = async () => {
    ...
    try {
      ...
      setAppState('connecting');
      await connectToRelay(manualSessionId.trim());
    } catch (error) {
      ...
      case 'scanning':
        return (
          <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>Enter session ID to connect</Text>

            <View style={styles.inputContainer}>
              <TextInput
                style={styles.input}
                placeholder="Session ID (e.g., 1nv9JumhHd1v17SxLu8pke)"
            ...
            <Text style={styles.hint}>
              Get the session ID from the desktop app
            </Text>
          </View>
        );
